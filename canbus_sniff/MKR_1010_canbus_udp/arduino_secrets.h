...
#define SECRET_SSID2 "coalajini"    // huawei lite 8
#define SECRET_PASS2 "olatalefta2u"
#define SECRET_SSID3 "MYSERVICE"    // jetson nano hotspot
#define SECRET_PASS3 "olatalefta2u"
#define SECRET_SSID4 "dummy"//"Wind WiFi x6JpcR"  //home network
