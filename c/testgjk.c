...
int setinput(double seed, double ***pts, int *out)
{
    int npoints = 4;
    int idx = 0;
    FILE *fp;
    ...
    for (idx = 0; idx < npoints; idx++)
    {
        arr[idx][0] = idx + 1.0 + seed;
        arr[idx][1] = idx + 2.0 + seed;
    }
